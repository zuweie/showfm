...
public class Novel extends MyData{
    ...
    public final static String NJAVATAR = "nj_avatar";
    ...
    public final static String FAVOUR = "favour";
    ...
    public ContentValues j2d(JSONObject jelem) throws JSONException {
        ...
        if (!jelem.isNull(Novel.NJAVATAR))
            data.put(Novel.NJAVATAR, jelem.getString(Novel.NJAVATAR));
    ...
    public ContentValues c2d(Cursor cursor) {
        ...
        data.put(Novel.NJAVATAR, cursor.getString(cursor.getColumnIndex(Novel.NJAVATAR)));
        ...
        data.put(Novel.FAVOUR, cursor.getInt(cursor.getColumnIndex(Novel.FAVOUR)));
